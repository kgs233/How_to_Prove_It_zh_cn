...
我们可以通过比较#link(<ex-1.1.1>)[例1.1.1]中的三个论点，来了解什么使一个论点有效。
...
更重要的是，我们对论证1和论证3形式的分析阐明了决定其有效性的关键：即_“或”（or）_和_“非”（not）_这两个词。在大多数演绎推理中，尤其是在数学推理中，仅仅几个词的含义便能为我们理解推理的有效性或无效性提供关键。（在#link(<ex-1.1.1>)[例 1.1.1]中的论证2中，哪些词是重要的？）本书的前几章致力于研究这些词语及其在数学写作和推理中的应用。
...
#example("分析以下陈述的逻辑形式：", label-name: "ex-1.1.2")[
  + 约翰去了商店，或者我们没有鸡蛋了。
  + 乔会离家并且不会回来了。
...
#example([以下表达式分别对应哪些中文句子？], label-name: "ex-1.1.3")[
...
有时，除了 and、or、not 之外的词也可以用来表达符号 $and$ 、$or$ 和 $not$ 所代表的含义。例如，考虑例 1.1.3 中的第一条陈述。尽管我们将其翻译为英语是：“Either John isn’t stupid and he is lazy, or he’s stupid”（要么 John 不是愚蠢的且他很懒惰，要么他是愚蠢的），另一种传达相同信息的方式可以是：“Either John isn’t stupid but he is lazy, or he’s stupid”（要么 John 不是愚蠢的但他很懒惰，要么他是愚蠢的）。在英语中，but 常常用来表示 and，尤其是在所连接的陈述之间存在某种对比或冲突时#footnote[译者注：中文中同理，比如有命题P、Q ，“ P，并且Q ”，“ P， 不过 Q”，“虽然 P，但是 Q ”，三个句子都能表示“ P $and$ Q ”]。
