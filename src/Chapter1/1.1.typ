...
更重要的是，我们对论证1和论证3形式的分析阐明了决定其有效性的关键：即_“或”（or）_和_“非”（not）_这两个词。在大多数演绎推理中，尤其是在数学推理中，仅仅几个词的含义便能为我们理解推理的有效性或无效性提供关键。（在#link(<ex-1.1.1>)[例1.1.1]中的论证2中，哪些词是重要的？）本书的前几章致力于研究这些词语及其在数学写作和推理中的应用。
